...
<Specs>
  ...
  <Spec label="Data" value="CMS Medicare Physician & Other Practitioners PUF · 2021–2025" />
...
<Diagram title="Pipeline — Databricks → Airflow → Domo">
  <div style={{ display: "flex", flexWrap: "wrap", alignItems: "stretch", gap: "8px", padding: "20px" }}>
    <div style={{ flex: "1 1 130px", border: "1px solid var(--color-graphite-80)", padding: "12px" }}>
      ...
      <p style={{ margin: "6px 0 0", fontSize: "13px" }}>CMS PUF CSVs 2021–2025, multi-GB, untyped</p>
    </div>
