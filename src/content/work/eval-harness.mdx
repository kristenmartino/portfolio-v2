...
<Specs>
  ...
  <Spec label="Status" value="Methodology shipped · Phase 1 execution in progress · v0.3 trajectory-eval harness built (165 tests)" />
</Specs>
